...
●更新履歴
Version 1.4.4
 - 三昧さーちのデータに一部不正なデータが含まれていた問題を修正
 - 三昧フォーマットの解析が特定のデータで失敗することがあった問題を修正

Version 1.4.3
 - スレッドへの投稿機能がエラーメッセージを表示するにもかかわらず投稿に成功することあがる問題を修正
 - スレッドへ投稿が正しい書式で行われない問題を修正

Version 1.4.2
 - スレッドへの「書き込み」機能が正常に動作しない問題を修正
 - 一行コピペ機能で楽曲情報の補正機能が動作しない問題を修正
...
Version 1.2.3
 - その他情報のスレッドへの書き込み時、番号が付加されてしまう問題を修正
 - クリップボードからの読み込み機能を多少汚いフォーマットでも対応できるよう修正
 - メインウィンドウに、クリップボードからの自動入力機能を追加

Version 1.2.2
 - 特定の動作でアプリケーションがクラッシュする問題を修正
